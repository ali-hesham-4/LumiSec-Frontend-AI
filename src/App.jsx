...
import SoarCanvas from './features/SOAR/Pages/SoarCanvas';
...
const myRouter = createBrowserRouter([
    ...
    { path: "/SOAR", element: <SoarCanvas/>},


    { path: "/SoarDashboard", element:
        //  <ProtectedRoute>
            ...
            , children:[
                ...
                { path: "/SoarDashboard/IncidentsQueue", element:  <IncidentQueue/>},
    
                { path: "/SoarDashboard/IncidentManagement", element:  <IncidentManagement/>},
